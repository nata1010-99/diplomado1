...
def show_transform_tab():
    ...
    st.markdown("""
    Se muestran el número total de registros recibidos y aquellos que fueron considerados válidos luego del proceso de limpieza.
    Esto incluye la conversión de datos a formato numérico y la eliminación de filas con valores faltantes.
    """)
    ...
    st.markdown("""
    Se construyen las dimensiones clave del modelo:
    - **Dimensión Tiempo**: Años únicos disponibles en el dataset.
    - **Dimensión Geográfica**: Departamentos y municipios únicos, relacionados con su código DANE.
    """)
    ...
    st.markdown("""
    La tabla de hechos representa la combinación de las dimensiones con las métricas educativas:
    población, tasa de matriculación, cobertura neta y cobertura bruta.
    """)
    ...
    st.markdown("""
    A continuación se presentan los municipios con mayor tasa de escolaridad promedio.
    Esto permite identificar regiones con mejor desempeño relativo.
    """)
    ...
    st.markdown("""
    Esta tabla presenta los departamentos con mayor cobertura neta promedio a lo largo del periodo analizado.
    """)
    ...
    st.markdown("""
    Puedes visualizar las primeras filas de la tabla consolidada y descargar el archivo completo en formato Excel para análisis adicionales.
    """)
    ...
    st.markdown("""
    Este resumen permite observar cómo evolucionan las métricas clave por departamento a lo largo del tiempo.
    """)
